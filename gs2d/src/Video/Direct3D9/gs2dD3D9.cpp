...
#include "../../Platform/windows/StdFileManager.h"
...
bool D3D9Video::GetZBuffer() const
{
	...
	return (dwEnable != D3DZB_FALSE) ? true : false;
}
...
bool D3D9Video::GetZWrite() const
{
	...
	return (dwEnable != FALSE) ? true : false;
}
...
bool D3D9Video::DrawBitmapText(const Vector2 &v2Pos, const std::wstring& text,
